...
class sina_oauth
{
    ...
    public function getAuthorizeURL() {
        ...
        $oauth = new SaeTOAuthV2('3124729371','97da6eba1b44ed46e3931a2a9eacdb64');    
		//echo 'app_key'.$this->setting['app_key'].'---------';
		//echo 'app_secret'.$this->setting['app_secret'];		
		
		return $oauth->getAuthorizeURL($this->redirect_uri);
		//return $oauth->getAuthorizeURL('http://www.ayoba.cn:8080/weibo/callback.php');		
